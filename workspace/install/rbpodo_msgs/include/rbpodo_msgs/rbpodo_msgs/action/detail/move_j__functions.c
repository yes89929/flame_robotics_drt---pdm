...
rbpodo_msgs__action__MoveJ_Goal__create()
{
  ...
  rbpodo_msgs__action__MoveJ_Goal * msg = (rbpodo_msgs__action__MoveJ_Goal *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rbpodo_msgs__action__MoveJ_Goal));
  bool success = rbpodo_msgs__action__MoveJ_Goal__init(msg);
  if (!success) {
...
rbpodo_msgs__action__MoveJ_Goal__destroy(rbpodo_msgs__action__MoveJ_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rbpodo_msgs__action__MoveJ_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_Goal__Sequence__init(rbpodo_msgs__action__MoveJ_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_Goal * data = NULL;

  if (size) {
    data = (rbpodo_msgs__action__MoveJ_Goal *)allocator.zero_allocate(size, sizeof(rbpodo_msgs__action__MoveJ_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rbpodo_msgs__action__MoveJ_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rbpodo_msgs__action__MoveJ_Goal__fini(&data[i - 1]);
      }
...
rbpodo_msgs__action__MoveJ_Goal__Sequence__fini(rbpodo_msgs__action__MoveJ_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rbpodo_msgs__action__MoveJ_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_Goal__Sequence * array = (rbpodo_msgs__action__MoveJ_Goal__Sequence *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rbpodo_msgs__action__MoveJ_Goal__Sequence__init(array, size);
  if (!success) {
...
rbpodo_msgs__action__MoveJ_Goal__Sequence__destroy(rbpodo_msgs__action__MoveJ_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rbpodo_msgs__action__MoveJ_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_Goal__Sequence__are_equal(const rbpodo_msgs__action__MoveJ_Goal__Sequence * lhs, const rbpodo_msgs__action__MoveJ_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rbpodo_msgs__action__MoveJ_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rbpodo_msgs__action__MoveJ_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rbpodo_msgs__action__MoveJ_Goal * data =
      (rbpodo_msgs__action__MoveJ_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rbpodo_msgs__action__MoveJ_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rbpodo_msgs__action__MoveJ_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_Result * msg = (rbpodo_msgs__action__MoveJ_Result *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rbpodo_msgs__action__MoveJ_Result));
  bool success = rbpodo_msgs__action__MoveJ_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_Result__destroy(rbpodo_msgs__action__MoveJ_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rbpodo_msgs__action__MoveJ_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_Result__Sequence__init(rbpodo_msgs__action__MoveJ_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_Result * data = NULL;

  if (size) {
    data = (rbpodo_msgs__action__MoveJ_Result *)allocator.zero_allocate(size, sizeof(rbpodo_msgs__action__MoveJ_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rbpodo_msgs__action__MoveJ_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rbpodo_msgs__action__MoveJ_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rbpodo_msgs__action__MoveJ_Result__Sequence__fini(rbpodo_msgs__action__MoveJ_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rbpodo_msgs__action__MoveJ_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_Result__Sequence * array = (rbpodo_msgs__action__MoveJ_Result__Sequence *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rbpodo_msgs__action__MoveJ_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_Result__Sequence__destroy(rbpodo_msgs__action__MoveJ_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rbpodo_msgs__action__MoveJ_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_Result__Sequence__are_equal(const rbpodo_msgs__action__MoveJ_Result__Sequence * lhs, const rbpodo_msgs__action__MoveJ_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rbpodo_msgs__action__MoveJ_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rbpodo_msgs__action__MoveJ_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rbpodo_msgs__action__MoveJ_Result * data =
      (rbpodo_msgs__action__MoveJ_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rbpodo_msgs__action__MoveJ_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rbpodo_msgs__action__MoveJ_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rbpodo_msgs__action__MoveJ_Feedback__init(rbpodo_msgs__action__MoveJ_Feedback * msg)
{
  ...
  if (!rbpodo_msgs__msg__SystemState__init(&msg->state)) {
    rbpodo_msgs__action__MoveJ_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_Feedback * msg = (rbpodo_msgs__action__MoveJ_Feedback *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rbpodo_msgs__action__MoveJ_Feedback));
  bool success = rbpodo_msgs__action__MoveJ_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_Feedback__Sequence__init(rbpodo_msgs__action__MoveJ_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_Feedback * data = NULL;

  if (size) {
    data = (rbpodo_msgs__action__MoveJ_Feedback *)allocator.zero_allocate(size, sizeof(rbpodo_msgs__action__MoveJ_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rbpodo_msgs__action__MoveJ_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rbpodo_msgs__action__MoveJ_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rbpodo_msgs__action__MoveJ_Feedback__Sequence__fini(rbpodo_msgs__action__MoveJ_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rbpodo_msgs__action__MoveJ_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_Feedback__Sequence * array = (rbpodo_msgs__action__MoveJ_Feedback__Sequence *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rbpodo_msgs__action__MoveJ_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_Feedback__Sequence__destroy(rbpodo_msgs__action__MoveJ_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rbpodo_msgs__action__MoveJ_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_Feedback__Sequence__are_equal(const rbpodo_msgs__action__MoveJ_Feedback__Sequence * lhs, const rbpodo_msgs__action__MoveJ_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rbpodo_msgs__action__MoveJ_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rbpodo_msgs__action__MoveJ_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rbpodo_msgs__action__MoveJ_Feedback * data =
      (rbpodo_msgs__action__MoveJ_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rbpodo_msgs__action__MoveJ_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rbpodo_msgs__action__MoveJ_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rbpodo_msgs__action__MoveJ_SendGoal_Request__init(rbpodo_msgs__action__MoveJ_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    rbpodo_msgs__action__MoveJ_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!rbpodo_msgs__action__MoveJ_Goal__init(&msg->goal)) {
    rbpodo_msgs__action__MoveJ_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
rbpodo_msgs__action__MoveJ_SendGoal_Request__fini(rbpodo_msgs__action__MoveJ_SendGoal_Request * msg)
{
  ...
  // goal
  rbpodo_msgs__action__MoveJ_Goal__fini(&msg->goal);
}
...
rbpodo_msgs__action__MoveJ_SendGoal_Request__are_equal(const rbpodo_msgs__action__MoveJ_SendGoal_Request * lhs, const rbpodo_msgs__action__MoveJ_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!rbpodo_msgs__action__MoveJ_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_SendGoal_Request * msg = (rbpodo_msgs__action__MoveJ_SendGoal_Request *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Request));
  bool success = rbpodo_msgs__action__MoveJ_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence__init(rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_SendGoal_Request * data = NULL;

  if (size) {
    data = (rbpodo_msgs__action__MoveJ_SendGoal_Request *)allocator.zero_allocate(size, sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rbpodo_msgs__action__MoveJ_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rbpodo_msgs__action__MoveJ_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence__fini(rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rbpodo_msgs__action__MoveJ_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence * array = (rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence__destroy(rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence__are_equal(const rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence * lhs, const rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rbpodo_msgs__action__MoveJ_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rbpodo_msgs__action__MoveJ_SendGoal_Request * data =
      (rbpodo_msgs__action__MoveJ_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rbpodo_msgs__action__MoveJ_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rbpodo_msgs__action__MoveJ_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rbpodo_msgs__action__MoveJ_SendGoal_Response__init(rbpodo_msgs__action__MoveJ_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    rbpodo_msgs__action__MoveJ_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_SendGoal_Response * msg = (rbpodo_msgs__action__MoveJ_SendGoal_Response *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Response));
  bool success = rbpodo_msgs__action__MoveJ_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence__init(rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_SendGoal_Response * data = NULL;

  if (size) {
    data = (rbpodo_msgs__action__MoveJ_SendGoal_Response *)allocator.zero_allocate(size, sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rbpodo_msgs__action__MoveJ_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rbpodo_msgs__action__MoveJ_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence__fini(rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rbpodo_msgs__action__MoveJ_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence * array = (rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence__destroy(rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence__are_equal(const rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence * lhs, const rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rbpodo_msgs__action__MoveJ_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rbpodo_msgs__action__MoveJ_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rbpodo_msgs__action__MoveJ_SendGoal_Response * data =
      (rbpodo_msgs__action__MoveJ_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rbpodo_msgs__action__MoveJ_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rbpodo_msgs__action__MoveJ_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rbpodo_msgs__action__MoveJ_GetResult_Request__init(rbpodo_msgs__action__MoveJ_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    rbpodo_msgs__action__MoveJ_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_GetResult_Request * msg = (rbpodo_msgs__action__MoveJ_GetResult_Request *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rbpodo_msgs__action__MoveJ_GetResult_Request));
  bool success = rbpodo_msgs__action__MoveJ_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence__init(rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_GetResult_Request * data = NULL;

  if (size) {
    data = (rbpodo_msgs__action__MoveJ_GetResult_Request *)allocator.zero_allocate(size, sizeof(rbpodo_msgs__action__MoveJ_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rbpodo_msgs__action__MoveJ_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rbpodo_msgs__action__MoveJ_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence__fini(rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rbpodo_msgs__action__MoveJ_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence * array = (rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence__destroy(rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence__are_equal(const rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence * lhs, const rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rbpodo_msgs__action__MoveJ_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rbpodo_msgs__action__MoveJ_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rbpodo_msgs__action__MoveJ_GetResult_Request * data =
      (rbpodo_msgs__action__MoveJ_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rbpodo_msgs__action__MoveJ_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rbpodo_msgs__action__MoveJ_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rbpodo_msgs__action__MoveJ_GetResult_Response__init(rbpodo_msgs__action__MoveJ_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!rbpodo_msgs__action__MoveJ_Result__init(&msg->result)) {
    rbpodo_msgs__action__MoveJ_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
rbpodo_msgs__action__MoveJ_GetResult_Response__fini(rbpodo_msgs__action__MoveJ_GetResult_Response * msg)
{
  ...
  // status
  // result
  rbpodo_msgs__action__MoveJ_Result__fini(&msg->result);
}
...
rbpodo_msgs__action__MoveJ_GetResult_Response__are_equal(const rbpodo_msgs__action__MoveJ_GetResult_Response * lhs, const rbpodo_msgs__action__MoveJ_GetResult_Response * rhs)
{
  ...
  // result
  if (!rbpodo_msgs__action__MoveJ_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_GetResult_Response * msg = (rbpodo_msgs__action__MoveJ_GetResult_Response *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rbpodo_msgs__action__MoveJ_GetResult_Response));
  bool success = rbpodo_msgs__action__MoveJ_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence__init(rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_GetResult_Response * data = NULL;

  if (size) {
    data = (rbpodo_msgs__action__MoveJ_GetResult_Response *)allocator.zero_allocate(size, sizeof(rbpodo_msgs__action__MoveJ_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rbpodo_msgs__action__MoveJ_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rbpodo_msgs__action__MoveJ_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence__fini(rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rbpodo_msgs__action__MoveJ_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence * array = (rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence__destroy(rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence__are_equal(const rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence * lhs, const rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rbpodo_msgs__action__MoveJ_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rbpodo_msgs__action__MoveJ_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rbpodo_msgs__action__MoveJ_GetResult_Response * data =
      (rbpodo_msgs__action__MoveJ_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rbpodo_msgs__action__MoveJ_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rbpodo_msgs__action__MoveJ_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
rbpodo_msgs__action__MoveJ_FeedbackMessage__init(rbpodo_msgs__action__MoveJ_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    rbpodo_msgs__action__MoveJ_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!rbpodo_msgs__action__MoveJ_Feedback__init(&msg->feedback)) {
    rbpodo_msgs__action__MoveJ_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
rbpodo_msgs__action__MoveJ_FeedbackMessage__fini(rbpodo_msgs__action__MoveJ_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  rbpodo_msgs__action__MoveJ_Feedback__fini(&msg->feedback);
}
...
rbpodo_msgs__action__MoveJ_FeedbackMessage__are_equal(const rbpodo_msgs__action__MoveJ_FeedbackMessage * lhs, const rbpodo_msgs__action__MoveJ_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!rbpodo_msgs__action__MoveJ_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_FeedbackMessage * msg = (rbpodo_msgs__action__MoveJ_FeedbackMessage *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rbpodo_msgs__action__MoveJ_FeedbackMessage));
  bool success = rbpodo_msgs__action__MoveJ_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence__init(rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_FeedbackMessage * data = NULL;

  if (size) {
    data = (rbpodo_msgs__action__MoveJ_FeedbackMessage *)allocator.zero_allocate(size, sizeof(rbpodo_msgs__action__MoveJ_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rbpodo_msgs__action__MoveJ_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rbpodo_msgs__action__MoveJ_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence__fini(rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rbpodo_msgs__action__MoveJ_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence * array = (rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence *)allocator.allocate(sizeof(rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence__destroy(rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence__are_equal(const rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence * lhs, const rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rbpodo_msgs__action__MoveJ_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rbpodo_msgs__action__MoveJ_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rbpodo_msgs__action__MoveJ_FeedbackMessage * data =
      (rbpodo_msgs__action__MoveJ_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rbpodo_msgs__action__MoveJ_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rbpodo_msgs__action__MoveJ_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rbpodo_msgs__action__MoveJ_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
